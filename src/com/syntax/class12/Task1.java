...
public class Task1 {
	...
	public static void main(String[] args) {
		...
		String username="Shanzeh25";
		String password="pass1234";
		String confirmPassword="pass1234";
		
		if (username.isEmpty()) {System.out.println("Username and Password cannot be empty");
		...
		}else if(password!=confirmPassword) {System.out.println("Passsword do not match");
